...
interface MarkAsReplyModalProps {
  isOpen: boolean;
  onClose: () => void;
  job: any;
...
const MarkAsReplyModal = ({ isOpen, onClose, job, fetchAppliedJobs }: MarkAsReplyModalProps) => {
              ...
              <div className="absolute mt-2 right-0 bg-white rounded-lg shadow-lg z-50 border w-[280px]">
                <DateRange
                  ...
                  onChange={(item: RangeKeyDict) =>
                    setSelectedDate(item.selection.startDate as Date)
                  }
