...
import ApplyManualJob from "@/components/modals/ApplyManualJob";
...
const AppliedJobsTable = ({ jobs, fetchAppliedJobs }: { jobs: any[]; fetchAppliedJobs: any }) => {
