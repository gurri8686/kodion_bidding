...
import { Search, Eye, UserCheck, UserX, X, AlertTriangle, User, Mail, Shield } from "lucide-react";

const ViewUser = ({ selectedUser, setViewModalOpen }) => {
    return (
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 m-4 w-full max-w-md">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className={`font-semibold ${selectedUser.status === 'active' ? 'text-green-600' : 'text-red-600'}`}>{selectedUser.status}</div>
                    </div>
                </div>
            </div>
        </div>
