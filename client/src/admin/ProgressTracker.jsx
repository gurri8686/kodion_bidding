...
import { Calendar, Target, X, Edit, Plus, AlertCircle } from "lucide-react";
...
const ProgressTracker = () => {
  ...
  const handleOpenModal = (mode) => {
    ...
    setFormAchievedAmount(mode === "edit" ? achievedAmount : "");
    setIsModalOpen(true);
  };
  ...
  const progress =
    targetAmount > 0
      ? Math.round(Math.min((achievedAmount / targetAmount) * 100, 100))
      : 0;
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-auto">
        <GlobalHeader title="Progress Tracker" />
          ...
          {loading ? (
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <select
                ...
                onChange={(e) =>
                  setSelectedWeek(weekOptions.find((w) => w.id == e.target.value))
                }
