 ...
 * @param {Function} setSelectedDate - Callback to update selected date
 * @param {string} position - Dropdown position: "above" or "below" (default: "below")
 * @param {boolean} withTime - Enable time selection (default: false)
 */
export const UnifiedDateTimePicker = ({
  ...
  const [timeValue, setTimeValue] = useState({
    ...
    period: selectedDate ? format(selectedDate, "a") : "AM",
  });
  ...
  const handleDateChange = (ranges) => {
    const selectedDateFromRange = ranges.selection.startDate;
