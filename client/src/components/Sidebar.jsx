  ...
  const menuItems =
    role === "admin"
      ? [
          ...
          // { label: "Ignored Jobs", path: "/admin/ignored-jobs", icon: <EyeOff size={18} /> },
          {
            label: "Hired Jobs",
          ...
          // { label: "Scrape Logs", path: "/admin/scrape-logs", icon: <Activity size={18} /> },
        ]
      : [
          {
            label: "Dashboard",
          ...
          // { label: "Ignored Jobs", path: "/dashboard/ignored-jobs", icon: <EyeOff size={18} /> },
          {
            label: "Hired Jobs",
          ...
          //  { label: "Connects Cost", path: "/admin/connects-cost", icon: <Plug size={18} /> },
          // { label: "Scrape Logs", path: "/dashboard/scrape-logs", icon: <Activity size={18} /> },
          {
            ...
            <ul className="space-y-2 mt-4 border-t border-[#4f5962]">
              {menuItems.map((item) => (
                <li key={item.path}>
                  <NavLink
                    to={item.path}
                    end={item.label === "Dashboard"} // Only Dashboard uses end={true}
                    className={({ isActive }) => {
                      // ...existing logic...
                      return `p-3 flex items-center gap-3 rounded ${
                        isActive
