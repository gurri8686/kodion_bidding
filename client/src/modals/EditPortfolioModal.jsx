...
const EditPortfolioModal = ({ isOpen, onClose, portfolio, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.put(
        `${API}/api/portfolios/${portfolio.id}`,
        {
      ...
      const errorMessage = error.response?.data?.message || "Failed to update portfolio. Please try again.";
