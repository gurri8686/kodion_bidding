            ...
            <div className="col-span-2">
              <div className="relative bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 rounded-3xl p-8 overflow-hidden h-64">
                ...
                <div className="absolute right-0 bottom-0 w-96 h-96">
                  ...
                  <svg viewBox="0 0 200 200" className="absolute bottom-4 right-8 w-64 h-64">
                    <ellipse cx="100" cy="140" rx="80" ry="20" fill="rgba(255,255,255,0.1)" transform="rotate(-20 100 140)" />
                    <ellipse cx="100" cy="100" rx="60" ry="80" fill="url(#pingPongGradient)" />
                    <line x1="40" y1="80" x2="160" y2="120" stroke="rgba(255,255,255,0.3)" strokeWidth="2" />
                    <defs>
                      <linearGradient id="pingPongGradient" x1="0%" y1="0%" x2="100%" y2="100%">
