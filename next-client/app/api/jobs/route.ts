 ...
 * POST /api/jobs - Save scraped jobs
 */
  ...
  try {
    ...
    if (jobType === 'fixed' && fixedPriceRange) {
      ...
      switch (fixedPriceRange) {
        case 'less-than-100': max = 100; break;
        case '100-500': min = 100; max = 500; break;
        case '500-1k': min = 500; max = 1000; break;
        case '1k-5k': min = 1000; max = 5000; break;
        case '5k-20k': min = 5000; max = 20000; break;
        case '20k-plus': min = 20000; break;
      }
